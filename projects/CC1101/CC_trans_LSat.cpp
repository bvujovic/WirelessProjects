//* Neuspesan pokusaj komunikacije izmedju CC1101 i SRX882.
...
// byte transmitt_byte[] = {72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100};
byte transmitt_byte[] = {72, 101, 108, 108, 111};
const char *transmitt_char = "Hello";
...
void loop()
{
    ...
    ELECHOUSE_cc1101.SendData("Hello", 1000);
    delay(2000);
